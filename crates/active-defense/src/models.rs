// models.rs — shared types for Phase 4 active defense
...
/// Request sent from Tauri command to ResponseEngine.
...
pub struct ActionRequest {
    ...
    pub kind:         ActionKind,
    /// Incident ID that triggered this action (for audit linkage)
    pub incident_id:  Option<String>,
    /// Cryptographic challenge token — must match server-generated value
    /// to prevent replay attacks and accidental double-triggers
    pub challenge:    String,
    /// Human operator note (shown in audit log)
    pub note:         String,
}
...
/// All failure modes from ResponseEngine.
